  ...
  implements AttributedObject, DescribedObject
{
  ...
  {
    abstract AbstractNamedObjectWithAttributes build();

    abstract Builder setRemarks(String remarks);
  ...
  {
    return new AutoValue_AbstractNamedObjectWithAttributes.Builder();
  }
